          ...
          <div className="p-6 border rounded-xl bg-white shadow-card border-green-900/5">
            ...
            <div className="space-y-2">
              ...
              <Link
                ...
                className="flex items-center justify-between p-3 rounded-lg hover:bg-green-900/5 transition-colors"
              >
                <span className="text-sm font-medium text-green-950">Paiements en attente & échoués</span>
              </Link>
              <Link
                href="/admin/payouts"
                className="flex items-center justify-between p-3 rounded-lg hover:bg-green-900/5 transition-colors"
              >
                <span className="text-sm font-medium text-green-950">Versements (manuels inclus)</span>
              </Link>
              <Link
                href="/admin/settings"
                className="flex items-center justify-between p-3 rounded-lg hover:bg-green-900/5 transition-colors"
              ...
              <Link
                ...
                className="flex items-center justify-between p-3 rounded-lg hover:bg-green-900/5 transition-colors"
              >
                <span className="text-sm font-medium text-green-950">Passerelle de paiement</span>
              </Link>
              <Link
              ...
              <Link
                href="/admin/summit-sponsors"
                className="flex items-center justify-between p-3 rounded-lg hover:bg-green-900/5 transition-colors"
              >
                <span className="text-sm font-medium text-green-950">Sponsors DIARRA Summit (paliers & logos)</span>
              </Link>
              <Link
                href="/admin/events"
                className="flex items-center justify-between p-3 rounded-lg hover:bg-green-900/5 transition-colors"
